...
function main() {
  ...
  const md: string[] = [
    ...
    `| No website in OSM or Google | ${groups.noWebsite.length} | Search for one by name — several of these DO have sites |`,
    "",
    "---",
    "",
    ...
    "",
    `## 5. No website found in OpenStreetMap or Google (${groups.noWebsite.length})`,
    "",
